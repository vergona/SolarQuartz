...
# Нарратив
## Близости и Предел
(defining principle) Воин Любви и Справедливости
(major tie) Команда Ниндзя
(minor tie) Соперник "Кисараги"
(minor principle) Противостояние Царству
...
## Атрибуты
базово: 8/6/4. бонусные очки: +1 стамина (4)
Физика (первичные)
	СИЛ 4
	ЛОВ 4
	ВЫН 4
...
Базовых очков: 28
Бонусных: 8 = 4 на каст/избр
==Кастовые==
- ***{S} Боевые Искусства(Стиль Сокола)*** {5} 3+2b
- **{c} Осознание** {3}
- **{c} Драка** {1}
- **{c} Сопротивление** {3}
- **{c} Метание** {2}
- **{c} Война(Разведка, Диверсия)** {2}
==Избранные==
- *{f} Атлетика* {3}
- *{f} Уклонение(от дальних атак)* {3}
- *{f} Целостность* {3}
- *{f} Присутствие(Вдохновлять)* {3}
- *{f} Скрытность* {3} 1+2b
==Прочие==
- Выживание   {1}
- Стрельба из лука
...
> [!example]- **Battle-Ready Troops** (3/0/Elite) 
> Join Battle: 6
...
> [!NOTE] [[Arms of the Chosen.pdf#page=36&selection=238,0,313,22|Arms of the Chosen, p.35-36]]
...
> [[00. Once, there was a maiden#Backstory]]
...
> ![[../../_attach/falcon style charm tree.pdf]]
...
# Предметы
- ==Железные ботинки==:
Light (Accuracy +4, Damage +7, Defense +0,  *Overwhelming* 1 - мин.урон изнуряющей атаки, который пройдет поверх поглощения)  
Tags: *Bashing* (тип урона для решающих атак), *Brawl* (навык для атаки), *Smashing* (пожертвуй 1 защиту и потрать 2 ед. инициативы; при успехе опрокинь врага или оттолкни его на 1 зону прочь), *Worn* (снятие и надевание считается за действие, надетые считаются естественным оружием - нельзя разоружить, и оно всегда готово)
- ==(Позже) Перчатки Земли и Небес==
Light (+5 ACC, +10 DMG, +0 DEF, *OVW* 3)  
