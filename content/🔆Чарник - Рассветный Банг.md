...
Defense: 
	Parry 5=(dex+MA)/2+weapDEF 		Evasion 4(dex+dodge)/2-armorMP
Movement: 
	Rush 7=dex+athletic 			Disengage 7=dex+dodge
Social:
	Resolve 3=(wits+integrity+spec)/2 			Guile   1=(man+socialize+spec)/2
